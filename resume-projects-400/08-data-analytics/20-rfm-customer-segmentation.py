#!/usr/bin/env python3
"""RFM Customer Segmentation - portfolio project 20 for 08 data analytics."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "RFM Customer Segmentation", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
