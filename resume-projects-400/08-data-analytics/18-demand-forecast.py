#!/usr/bin/env python3
"""Demand Forecast - portfolio project 18 for 08 data analytics."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Demand Forecast", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
