#!/usr/bin/env python3
"""IOC Matching Tool - portfolio project 21 for 16 cybersecurity automation."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "IOC Matching Tool", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
