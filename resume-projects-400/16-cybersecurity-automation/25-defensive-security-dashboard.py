#!/usr/bin/env python3
"""Defensive Security Dashboard - portfolio project 25 for 16 cybersecurity automation."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Defensive Security Dashboard", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
