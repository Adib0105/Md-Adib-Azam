#!/usr/bin/env python3
"""Access Log Threat Monitor - portfolio project 02 for 16 cybersecurity automation."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Access Log Threat Monitor", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
