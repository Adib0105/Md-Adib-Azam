#!/usr/bin/env python3
"""Resume Keyword Scanner - portfolio project 23 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Resume Keyword Scanner", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
