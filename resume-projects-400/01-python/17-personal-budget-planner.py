#!/usr/bin/env python3
"""Personal Budget Planner - portfolio project 17 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Personal Budget Planner", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
