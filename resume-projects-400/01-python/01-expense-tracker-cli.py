#!/usr/bin/env python3
"""Expense Tracker CLI - portfolio project 01 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Expense Tracker CLI", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
