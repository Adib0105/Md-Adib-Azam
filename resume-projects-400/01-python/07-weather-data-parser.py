#!/usr/bin/env python3
"""Weather Data Parser - portfolio project 07 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Weather Data Parser", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
