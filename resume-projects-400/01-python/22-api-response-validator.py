#!/usr/bin/env python3
"""API Response Validator - portfolio project 22 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "API Response Validator", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
