#!/usr/bin/env python3
"""Backup Utility - portfolio project 21 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Backup Utility", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
