#!/usr/bin/env python3
"""Duplicate File Finder - portfolio project 13 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Duplicate File Finder", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
