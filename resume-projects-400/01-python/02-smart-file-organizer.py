#!/usr/bin/env python3
"""Smart File Organizer - portfolio project 02 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Smart File Organizer", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
