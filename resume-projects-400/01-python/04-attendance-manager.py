#!/usr/bin/env python3
"""Attendance Manager - portfolio project 04 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Attendance Manager", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
