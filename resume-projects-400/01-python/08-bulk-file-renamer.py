#!/usr/bin/env python3
"""Bulk File Renamer - portfolio project 08 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Bulk File Renamer", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
