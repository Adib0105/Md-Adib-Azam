#!/usr/bin/env python3
"""CSV Cleaner - portfolio project 14 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "CSV Cleaner", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
