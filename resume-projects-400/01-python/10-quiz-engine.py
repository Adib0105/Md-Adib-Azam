#!/usr/bin/env python3
"""Quiz Engine - portfolio project 10 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Quiz Engine", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
