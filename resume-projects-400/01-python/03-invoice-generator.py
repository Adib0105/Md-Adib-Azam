#!/usr/bin/env python3
"""Invoice Generator - portfolio project 03 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Invoice Generator", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
