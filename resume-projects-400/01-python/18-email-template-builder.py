#!/usr/bin/env python3
"""Email Template Builder - portfolio project 18 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Email Template Builder", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
