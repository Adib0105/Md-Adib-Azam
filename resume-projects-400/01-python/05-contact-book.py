#!/usr/bin/env python3
"""Contact Book - portfolio project 05 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Contact Book", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
