#!/usr/bin/env python3
"""URL Health Monitor - portfolio project 12 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "URL Health Monitor", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
