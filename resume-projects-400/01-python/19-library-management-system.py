#!/usr/bin/env python3
"""Library Management System - portfolio project 19 for 01 python."""
...
def analyze(records: list[dict]) -> dict:
    ...
    return {"project": "Library Management System", "records": len(records), "total": round(sum(values), 2), "average": round(sum(values) / len(values), 2) if values else 0}
