...
> Design a measurable multi-channel campaign.
...
- **objective**: required, user-supplied data
- **audience**: required, user-supplied data
- **offer**: required, user-supplied data
- **budget**: required, user-supplied data
- **channels**: required, user-supplied data

If a required field is absent or materially ambiguous, ask one focused question before producing the deliverable.

## Procedure

1. Define funnel stage.
2. Allocate budget with rationale.
3. Create testable hypotheses.
4. Set stop or scale rules.
