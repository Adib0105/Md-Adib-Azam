...
> Compose an identity-preserving image-generation prompt.
...
- **subject_reference**: required, user-supplied data
- **scene**: required, user-supplied data
- **pose**: required, user-supplied data
- **wardrobe**: required, user-supplied data
...
1. Prioritize identity facts.
2. Specify composition and light.
3. Preserve realistic anatomy.
4. Write a concise negative prompt.
