...
> Create an auditable spreadsheet formula.
...
- **sheet_layout**: required, user-supplied data
- **sample_rows**: required, user-supplied data
- **excel_version**: required, user-supplied data

If a required field is absent or materially ambiguous, ask one focused question before producing the deliverable.

## Procedure

1. Identify input and output cells.
2. Choose supported functions.
3. Handle blanks and zeroes.
4. Explain absolute references.
